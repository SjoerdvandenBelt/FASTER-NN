...
char alleleMask_binary (char c, int * isDerived, int * isValid, FILE * fpOut)
{
	...
	*isValid = 0;
	...
	switch(c)
	{
		...
		case '2': // TODO: this was added for Stefan's datasets
			*isDerived = 1;
			*isValid = 1;
			return '1';

		case '3': // TODO: this was added for Stefan's datasets
			*isDerived = 1;
			*isValid = 1;
			return '1';
...
int is_valid_NN_architecture (char * arc)
{
	...
	if(!strcmp(arc, ARC_SWEEPNET1DDET))
		return 1;
...
void get_print_slen (int * slen, void * input, int mode) // mode=0 for ints, mode=1 for strings
{
	assert(slen!=NULL);
	assert(input!=NULL);
	...
	switch(mode)
	{
		case 0: // int
			char tstring[STRING_SIZE];
			int * tinput = (int*)input;
			int tvalue = *tinput;
			sprintf(tstring, "%d", tvalue);
			*slen = (int)strlen(tstring)>*slen?(int)strlen(tstring):*slen;
			break;
		case 1: // string
			char * string = (char*)input;
			*slen = (int)strlen(string)>*slen?(int)strlen(string):*slen;
			break;
		case 2: // double
			char tstring2[STRING_SIZE];
			double * tinput2 = (double*)input;
			double tvalue2 = *tinput2;
			sprintf(tstring2, "%.0f", tvalue2);
			*slen = (int)strlen(tstring2)>*slen?(int)strlen(tstring2):*slen;
			break;
		case 3: // exp
			char tstring3[STRING_SIZE];
			double * tinput3 = (double*)input;
			double tvalue3 = *tinput3;
			sprintf(tstring3, "%.3e", tvalue3);
			*slen = (int)strlen(tstring3)>*slen?(int)strlen(tstring3):*slen;
			break;
		default:
			assert(0);
			break;
...
//					slen0 = (int)strlen(RSDDataset->setID)>slen0?(int)strlen(RSDDataset->setID):slen0;

//				sprintf(tstring, "%d", (int)RSDDataset->setSize);
//				slen1 = (int)strlen(tstring)>slen1?(int)strlen(tstring):slen1;

//				sprintf(tstring, "%d", (int)RSDDataset->setSNPs);
//				slen2 = (int)strlen(tstring)>slen2?(int)strlen(tstring):slen2;
...
/*const char * raisd = "\n\
  o8o  ooooooooo.         .o.        o8o   .oooooo..o oooooooooo.\n\
 `\"'   `888   `Y88.      .888.       `\"'  d8P'    `Y8 `888'   `Y8b\n\
 oooo   888   .d88'     .8\"888.     oooo  Y88bo.       888      888\n\
 `888   888ooo88P'     .8' `888.    `888   `\"Y8888o.   888      888\n\
  888   888`88b.      .88ooo8888.    888       `\"Y88b  888      888\n\
  888   888  `88b.   .8'     `888.   888  oo     .d8P  888     d88'\n\
 o888o o888o  o888o o88o     o8888o o888o 8\"\"88888P'  o888bood8P'\n\ 
";
*/
